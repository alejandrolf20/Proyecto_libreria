...
@app.route('/autores/<autores>')
def autores(autores):
    filtered_books = [book for book in books_data if autores in book['authors']]
    return render_template('categoria.html', autores=autores, libros=filtered_books)
